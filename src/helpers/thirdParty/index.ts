...
export const MODBUS_REGISTER_MAP: ModbusRegisterMap[] = [
  ...
  },
  {
    reg: "2156",
    section: "Generator Setting",
    field: "Generator Dry force ON/OFF",
    unit: "enum",
    rw: "RW",
  },
  {
  ...
  },
  {
    reg: "215A",
    section: "Generator Setting",
    field: "Run Duration (Manual Start)",
    unit: "min",
    rw: "RW",
  },
  {
  ...
  // Generator Runtime Data - Phase L1
  {
    reg: "136A",
    section: "Generator Runtime",
    field: "L1 phase voltage",
    decode: fV,
    unit: "V",
    rw: "R",
  },
  ...
  },
  {
    reg: "136D",
    section: "Generator Runtime",
    field: "L1 phase power",
    decode: fV,
    unit: "W",
    rw: "R",
  },

  // Generator Runtime Data - Phase L2
  {
    reg: "136F",
    section: "Generator Runtime",
    field: "L2 phase voltage",
    decode: fV,
    unit: "V",
    rw: "R",
  },
  ...
  },
  {
    reg: "1372",
    section: "Generator Runtime",
    field: "L2 phase power",
    decode: fV,
    unit: "W",
    rw: "R",
  },

  // Generator Runtime Data - Phase L3
  {
    reg: "1374",
    section: "Generator Runtime",
    field: "L3 phase voltage",
    decode: fV,
    unit: "V",
    rw: "R",
  },
  ...
  },
  {
    reg: "1377",
    section: "Generator Runtime",
    field: "L3 phase power",
    decode: fV,
    unit: "W",
    rw: "R",
  },

  // Generator Energy & Frequency
  {
    reg: "1379",
    section: "Generator Runtime",
    field: "Generator frequency",
    decode: fHz,
    unit: "Hz",
    rw: "R",
  },
  ...
  },
  {
    reg: "137C",
    section: "Generator Runtime",
    field: "Generator total energy",
    decode: div(100),
    unit: "kWh",
    rw: "R",
  },

  // Generator Phase Sums
  {
    reg: "13C4",
    section: "Generator Summary",
    field: "Phase L1 watt sum",
    decode: fV,
    unit: "W",
    rw: "R",
  },
  ...
  },
  {
    reg: "13CA",
    section: "Generator Summary",
    field: "Phase L1 apparent power sum",
    decode: fV,
    unit: "VA",
    rw: "R",
  },
  {
    reg: "13CC",
    section: "Generator Summary",
    field: "Phase L2 apparent power sum",
    decode: fV,
    unit: "VA",
    rw: "R",
  },
  {
    reg: "13CE",
    section: "Generator Summary",
    field: "Phase L3 apparent power sum",
    decode: fV,
    unit: "VA",
    rw: "R",
  },
  {
    reg: "13D0",
    section: "Generator Summary",
    field: "Generator today energy sum",
    decode: div(100),
    unit: "kWh",
    rw: "R",
  },
  {
    reg: "13D2",
    section: "Generator Summary",
    field: "Generator total energy sum",
    decode: div(100),
    unit: "kWh",
    rw: "R",
  },
